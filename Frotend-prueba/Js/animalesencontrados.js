...
async function buscar_filtro() {
    ...
    let condiciones = ["status='encontrado'"];
...
function mostrarPublicaciones(publicaciones, publicacionesContainer) {
    publicaciones.forEach(async (publicacion) => {
        ...
        try {
            ...
            card.innerHTML = `
                <img src="${animal.imagen_url || 'https://via.placeholder.com/300'}" alt="Animal Encontrado" style="width: 100%; height: 295px; object-fit: cover; border-radius: 10px;">
